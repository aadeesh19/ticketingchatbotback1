...
const messages = {
  ...
  Marathi: {
    ...
    askTickets: "तुम्हाला किती तिकीटे हवेत?",
    ...
    invalidDate: "वाईट वाटते, दिलेला दिनांक चुकीचा आहे किंवा भूतकाळाचा आहे. कृपया योग्य दिनांक द्या.",
  ...
  Malayalam: {
    ...
    tourOptions: [
      "ദിൻ ദില്ലി കി ധരോഹർ (മോണിങ് സർക്യൂട്ട്-1)",
      "ദിൻ ദില്ലി ക റഹസ്യ (മോണിങ് സർക്യൂട്ട്-2)",
      "രാഷ്ട്രപതി ഭവൻ (ചേഞ്ച് ഓഫ് ഗാർഡ് സെറിമണി - ദില്ലി ക റൈസീന ഹൗസ്)"
    ],
    bookLink: "https://delhitourism.gov.in/ebooking/DekhoMeriDilli",
    cancelLink: "https://delhitourism.gov.in/ebooking/cancellation"
  }
...
// Simple root route
app.get('/', (req, res) => {
  res.send('Ticket Booking Chatbot Backend is running.');
});
